...
namespace sim {
    ...
    class transpiler {
        class token{
        public:
            enum token_type {NAME, SYSTEM_COMMAND, DECL_END, ARGS_START, ARGS_END, ACCESSOR, ARRAY_ACCESSOR_BEGIN, ARRAY_ACCESSOR_END, LIST_DELIMITER, WIRE_DECL, MODULE_DECL};
            std::string value;
            token_type t_type;
