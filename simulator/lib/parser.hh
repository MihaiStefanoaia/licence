...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // args
      // access
      char dummy2[sizeof (nlohmann::json)];
...
switch (yytype)
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_ARGS_B || tok == token::TOK_ARGS_E || tok == token::TOK_ACC_B || tok == token::TOK_ACC_E || tok == token::TOK_DOLLAR || tok == token::TOK_SEMIC || tok == token::TOK_COMMA || tok == token::TOK_COLON || tok == token::TOK_WIRE || tok == token::TOK_ARRAY || tok == token::TOK_LT || tok == token::TOK_GT || tok == token::TOK_AUTOGEN || tok == token::TOK_LAYOUT);
      }
#else
    ...
    parser (sim::transpiler& trp_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_ARGS_B (location_type l)
      {
        return symbol_type (token::TOK_ARGS_B, std::move (l));
      }
#else
      static
      symbol_type
      make_ARGS_B (const location_type& l)
      {
        return symbol_type (token::TOK_ARGS_B, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ARGS_E (location_type l)
      {
        return symbol_type (token::TOK_ARGS_E, std::move (l));
      }
#else
      static
      symbol_type
      make_ARGS_E (const location_type& l)
      {
        return symbol_type (token::TOK_ARGS_E, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ACC_B (location_type l)
      {
        return symbol_type (token::TOK_ACC_B, std::move (l));
      }
#else
      static
      symbol_type
      make_ACC_B (const location_type& l)
      {
        return symbol_type (token::TOK_ACC_B, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ACC_E (location_type l)
      {
        return symbol_type (token::TOK_ACC_E, std::move (l));
      }
#else
      static
      symbol_type
      make_ACC_E (const location_type& l)
      {
        return symbol_type (token::TOK_ACC_E, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LAYOUT (location_type l)
      {
        return symbol_type (token::TOK_LAYOUT, std::move (l));
      }
#else
      static
      symbol_type
      make_LAYOUT (const location_type& l)
      {
        return symbol_type (token::TOK_LAYOUT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
